...
from src.workspace_utils import active_session
...
def optimize(data_loaders, model, optimizer, loss, n_epochs, save_path, interactive_tracking=True):
    ...
    # plateau torch.save(model.state_dict(), save_path)
    # HINT: look here: 
